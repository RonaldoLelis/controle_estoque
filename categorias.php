		...
		<div class="container-fluid">					   
			<div class="topo2">
				...
				<div class="conteudo">
					...
					<h3 class="col-md-4 control-label" for="termo">Cadastro de Categorias</h3>
					<button type="button" data-toggle="modal" data-target="#myModalcad" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Nova Categoria</button>
					</div> <!-- /#top -->
					<br>
						...
						<div class="modal-content">
							<div class="modal-header">				
								<h3 class="modal-title text-center" id="myModalLabel"><strong>Cadastrar Categoria</strong></h3>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							</div>
							<div class="modal-body">
								<form method="POST" action="grava_categoria.php" enctype="multipart/form-data">
									<div class="form-row">
										<div class="col-8">
